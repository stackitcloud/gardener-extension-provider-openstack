...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*ExternalBlackboxExporterConfig)(nil), (*config.ExternalBlackboxExporterConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_ExternalBlackboxExporterConfig_To_config_ExternalBlackboxExporterConfig(a.(*ExternalBlackboxExporterConfig), b.(*config.ExternalBlackboxExporterConfig), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.ExternalBlackboxExporterConfig)(nil), (*ExternalBlackboxExporterConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_ExternalBlackboxExporterConfig_To_v1alpha1_ExternalBlackboxExporterConfig(a.(*config.ExternalBlackboxExporterConfig), b.(*ExternalBlackboxExporterConfig), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*NodeExporterConfig)(nil), (*config.NodeExporterConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_NodeExporterConfig_To_config_NodeExporterConfig(a.(*NodeExporterConfig), b.(*config.NodeExporterConfig), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.NodeExporterConfig)(nil), (*NodeExporterConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_NodeExporterConfig_To_v1alpha1_NodeExporterConfig(a.(*config.NodeExporterConfig), b.(*NodeExporterConfig), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_ExternalBlackboxExporterConfig_To_config_ExternalBlackboxExporterConfig(in *ExternalBlackboxExporterConfig, out *config.ExternalBlackboxExporterConfig, s conversion.Scope) error {
	out.URL = in.URL
	out.Module = in.Module
	return nil
}

// Convert_v1alpha1_ExternalBlackboxExporterConfig_To_config_ExternalBlackboxExporterConfig is an autogenerated conversion function.
func Convert_v1alpha1_ExternalBlackboxExporterConfig_To_config_ExternalBlackboxExporterConfig(in *ExternalBlackboxExporterConfig, out *config.ExternalBlackboxExporterConfig, s conversion.Scope) error {
	return autoConvert_v1alpha1_ExternalBlackboxExporterConfig_To_config_ExternalBlackboxExporterConfig(in, out, s)
}

func autoConvert_config_ExternalBlackboxExporterConfig_To_v1alpha1_ExternalBlackboxExporterConfig(in *config.ExternalBlackboxExporterConfig, out *ExternalBlackboxExporterConfig, s conversion.Scope) error {
	out.URL = in.URL
	out.Module = in.Module
	return nil
}

// Convert_config_ExternalBlackboxExporterConfig_To_v1alpha1_ExternalBlackboxExporterConfig is an autogenerated conversion function.
func Convert_config_ExternalBlackboxExporterConfig_To_v1alpha1_ExternalBlackboxExporterConfig(in *config.ExternalBlackboxExporterConfig, out *ExternalBlackboxExporterConfig, s conversion.Scope) error {
	return autoConvert_config_ExternalBlackboxExporterConfig_To_v1alpha1_ExternalBlackboxExporterConfig(in, out, s)
}
...
func autoConvert_v1alpha1_NodeExporterConfig_To_config_NodeExporterConfig(in *NodeExporterConfig, out *config.NodeExporterConfig, s conversion.Scope) error {
	out.AdditionalArgs = *(*[]string)(unsafe.Pointer(&in.AdditionalArgs))
	return nil
}

// Convert_v1alpha1_NodeExporterConfig_To_config_NodeExporterConfig is an autogenerated conversion function.
func Convert_v1alpha1_NodeExporterConfig_To_config_NodeExporterConfig(in *NodeExporterConfig, out *config.NodeExporterConfig, s conversion.Scope) error {
	return autoConvert_v1alpha1_NodeExporterConfig_To_config_NodeExporterConfig(in, out, s)
}

func autoConvert_config_NodeExporterConfig_To_v1alpha1_NodeExporterConfig(in *config.NodeExporterConfig, out *NodeExporterConfig, s conversion.Scope) error {
	out.AdditionalArgs = *(*[]string)(unsafe.Pointer(&in.AdditionalArgs))
	return nil
}

// Convert_config_NodeExporterConfig_To_v1alpha1_NodeExporterConfig is an autogenerated conversion function.
func Convert_config_NodeExporterConfig_To_v1alpha1_NodeExporterConfig(in *config.NodeExporterConfig, out *NodeExporterConfig, s conversion.Scope) error {
	return autoConvert_config_NodeExporterConfig_To_v1alpha1_NodeExporterConfig(in, out, s)
}
