...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*BastionVolume)(nil), (*config.BastionVolume)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_BastionVolume_To_config_BastionVolume(a.(*BastionVolume), b.(*config.BastionVolume), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.BastionVolume)(nil), (*BastionVolume)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_BastionVolume_To_v1alpha1_BastionVolume(a.(*config.BastionVolume), b.(*BastionVolume), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_BastionConfig_To_config_BastionConfig(in *BastionConfig, out *config.BastionConfig, s conversion.Scope) error {
	...
	out.Volume = (*config.BastionVolume)(unsafe.Pointer(in.Volume))
	return nil
}
...
func autoConvert_config_BastionConfig_To_v1alpha1_BastionConfig(in *config.BastionConfig, out *BastionConfig, s conversion.Scope) error {
	out.ImageRef = in.ImageRef
	out.FlavorRef = in.FlavorRef
	out.Volume = (*BastionVolume)(unsafe.Pointer(in.Volume))
	return nil
}
...
func autoConvert_v1alpha1_BastionVolume_To_config_BastionVolume(in *BastionVolume, out *config.BastionVolume, s conversion.Scope) error {
	out.Type = in.Type
	out.Size = (*resource.Quantity)(unsafe.Pointer(in.Size))
	return nil
}

// Convert_v1alpha1_BastionVolume_To_config_BastionVolume is an autogenerated conversion function.
func Convert_v1alpha1_BastionVolume_To_config_BastionVolume(in *BastionVolume, out *config.BastionVolume, s conversion.Scope) error {
	return autoConvert_v1alpha1_BastionVolume_To_config_BastionVolume(in, out, s)
}

func autoConvert_config_BastionVolume_To_v1alpha1_BastionVolume(in *config.BastionVolume, out *BastionVolume, s conversion.Scope) error {
	out.Type = in.Type
	out.Size = (*resource.Quantity)(unsafe.Pointer(in.Size))
	return nil
}

// Convert_config_BastionVolume_To_v1alpha1_BastionVolume is an autogenerated conversion function.
func Convert_config_BastionVolume_To_v1alpha1_BastionVolume(in *config.BastionVolume, out *BastionVolume, s conversion.Scope) error {
	return autoConvert_config_BastionVolume_To_v1alpha1_BastionVolume(in, out, s)
}
